...
def find_plectonemes(config: np.ndarray,min_writhe_density: float,plec_min_writhe: float ,disc_len=None, no_branch_overlap=True ,connect_dist=10.0, om0=1.76,include_wm=False):
